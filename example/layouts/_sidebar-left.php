...
<aside id="sidebar-left" class="<?php echo !empty($classLeft)? $classLeft : 'sidebar-circle' ?>">
    ...
    <div class="sidebar-content">
        <div class="media">
            <a class="pull-left has-notif avatar" href="<?= Url::toRoute(['admin/page/profile']) ?>">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="<?= (Yii::$app->controller->id == 'dashboard') ? 'active' : '' ?>">
            <a href="<?= Url::toRoute(['admin/dashboard/index']) ?>">
        ...
        <li class="submenu <?= (Yii::$app->controller->id == 'blog') ? 'active' : '' ?>">
            ...
            <ul>
                <li class="<?= (Yii::$app->controller->action->id == 'grid') ? 'active' : '' ?>">
                    <a href="<?= Url::toRoute(['admin/blog/grid']) ?>">Grid</a>
                </li>
                <li class="<?= (Yii::$app->controller->action->id == 'list') ? 'active' : '' ?>">
                    <a href="<?= Url::toRoute(['admin/blog/list']) ?>">List</a>
                </li>
                <li class="<?= (Yii::$app->controller->action->id == 'single') ? 'active' : '' ?>">
                    <a href="<?= Url::toRoute(['admin/blog/single']) ?>">Single</a>
                </li>
            </ul>
        </li>
        <!--/ End navigation - blog -->
        ...
        <li class="submenu <?= (Yii::$app->controller->id == 'mail') ? 'active' : '' ?>">
            ...
            <ul>
                <li class="<?= (Yii::$app->controller->action->id == 'inbox') ? 'active' : '' ?>"><a href="<?= Url::toRoute(['admin/mail/inbox']) ?>">Inbox</a></li>
                <li class="<?= (Yii::$app->controller->action->id == 'compose') ? 'active' : '' ?>"><a href="<?= Url::toRoute(['admin/mail/compose']) ?>">Compose mail</a></li>
                <li class="<?= (Yii::$app->controller->action->id == 'view') ? 'active' : '' ?>"><a href="<?= Url::toRoute(['admin/mail/view']) ?>">View mail</a></li>
            </ul>
        </li>
        <!--/ End navigation - mail -->
