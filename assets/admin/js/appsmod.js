...
//            BlankonApp.handleBoxModal();
        ...
        handleSidebarNavigation: function () {
            ...
            $('.submenu > a').click(function() {
                ...
                if(parentElement.parent('ul').find('ul:visible')){
                    parentElement.parent('ul').find('ul:visible').slideUp('fast', function () {
                        $("#sidebar-left .sidebar-menu").getNiceScroll().resize()
                    });
                ...
                if(nextElement.is('ul:visible')) {
                    ...
                    nextElement.slideUp('fast', function () {
                        $("#sidebar-left .sidebar-menu").getNiceScroll().resize()
                    });
                ...
                if(!nextElement.is('ul:visible')) {
                    ...
                    nextElement.slideDown('fast', function () {
                        $("#sidebar-left .sidebar-menu").getNiceScroll().resize()
                    });
        ...
        // TABLE LINKS
        // =========================================================================
        handleTableLinks : function (percent) {
            if (percent == null) percent = 15;
            $('.table tbody tr td a:not(\'.btn\')').each(function() {
                var darkenPercent = percent; // darken color by percent
