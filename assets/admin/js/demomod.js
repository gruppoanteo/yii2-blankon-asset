...
//    var adminCssPath = BlankonApp.handleBaseURL()+'/assets/admin/css';
    var adminCssPath = $('link#theme').attr('href').substring(0, $('link#theme').attr('href').lastIndexOf("/"));
...
//            BlankonDemo.handleLayoutSetting();
        ...
        handleChooseThemes: function () {
            ...
            if ($.cookie('color_schemes')) {
                $('link#theme').attr('href', adminCssPath+'/'+$.cookie('color_schemes')+'.theme.css');
            }
            ...
            $('.color-schemes .theme').on('click',function(){
                ...
                $('link#theme').attr('href', adminCssPath+'/'+themename+'.theme.css');
